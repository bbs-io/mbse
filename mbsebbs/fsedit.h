...
extern int		Row;		/* Current row on screen		*/
extern int		Col;		/* Current column in text and on screen	*/
extern int		TopVisible;	/* First visible line of text		*/
extern int		InsMode;	/* Insert mode				*/
extern int		CurRow;		/* Current row in buffer		*/
